...
export function SliderVideo() {
  return (
    <div className="relative w-full h-[80vw] md:h[56.23vw] lg:h-[45vw]">
      <video 
        autoPlay
        loop
        muted
        className="brightness-50 object-fill w-full h-[80wv] md:h-[56.25vw] lg:h-[45vw]"
        ...
        <div className="pt-24 md:pt-0">
          ...
          <div className="flex flex-col md:flex-row gap-4 mt-5">
            <Button size="lg" variant="secondary">
              <Play className="mr-h-6 w-6 mr-2 fill-black" />
              Reproducir
            </Button>
